...
const customcolor1 = Color(0xFF93EC46);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF93EC46),
  customcolor1: Color(0xFF376B00),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFA0FA53),
  onCustomcolor1Container: Color(0xFF0C2000),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF93EC46),
  customcolor1: Color(0xFF85DC37),
  onCustomcolor1: Color(0xFF1A3700),
  customcolor1Container: Color(0xFF285000),
  onCustomcolor1Container: Color(0xFFA0FA53),
);
